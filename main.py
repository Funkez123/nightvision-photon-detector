...
while cap.isOpened():
    ...
    if frame is None: ## If - Abfrage um zu schauen ob es noch weitere Frames gibt die man bearbeitet kann (zum Vermeiden von OpenCV2 Fehlern)
        ...
        ### Erneute Fehlerkorrektur am Bildrand durch Streifen
        ...
        gray2 = cv2.line(gray2, startpunkt1, endpunkt1,  farbe, dicke) #A
        gray2 = cv2.line(gray2, startpunkt2, endpunkt2,  farbe, dicke)  #B
        gray2 = cv2.line(gray2, startpunkt3, endpunkt3,  farbe, dicke)  #C
        gray2 = cv2.line(gray2, startpunkt4, endpunkt4,  farbe, dicke)  #D

        ## erneutes Weichzeichnen der Photonen-Frames
